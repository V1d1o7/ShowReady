...
const RackPdfModal = ({ isOpen, onClose, onGenerate }) => {
    const [pageSize, setPageSize] = useState('letter');
    const availableSizes = ['letter', 'tabloid'];
    ...
    return (
        <Modal isOpen={isOpen} onClose={onClose} title="Generate Racks PDF" maxWidth="max-w-md">
